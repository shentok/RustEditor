...
bool RustEditorPlugin::initialize(const QStringList &arguments, QString *errorString)
{
...
void RustEditorPlugin::extensionsInitialized()
{
...
ExtensionSystem::IPlugin::ShutdownFlag RustEditorPlugin::aboutToShutdown()
{
    // Save settings
